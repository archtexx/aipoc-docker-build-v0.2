...
function Provider({ children }) {
  ...
  const [selectedOperation, setSelectedOperation] = useState('SQL - LLM')
  ...
  const valueToShare = {
    ...
    getConversation, temperature, setTemperature, tokens, setToken, promptMsg, setPromptMsg, chunkoverlap,setChunkoverlap,fileList, getFilesList, deleteFile,
