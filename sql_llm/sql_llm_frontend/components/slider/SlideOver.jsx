...
const SlideOver = ({ toggleDarkMode, mode }) => {
    ...
    const [chunkoverlapValue,setChunkoverlapValue]=useState(chunkoverlap)
    ...
    const handleSubmit = (e) => {
        ...
        setToken(tokenValue);
        setChunkoverlap(chunkoverlapValue)
                                        ...
                                        <div className={`flex h-full flex-col overflow-y-scroll ${mode ? 'bg-gray-800' : 'bg-white'} py-6 shadow-xl`}>
                                            ...
                                            <div className={`relative mt-6 flex-1 px-4 sm:px-6`}>
                                                <div className="mx-5 flex flex-col gap-y-2">
                                                    ...
                                                    />
                                                       <SliderContainer
                                                        defaultValue={chunkoverlapValue}
                                                        min={20}
                                                        step={2}
                                                        max={256}
                                                        title="Chunk_overlap"
                                                        sliderValue={chunkoverlapValue}
                                                        onChange={(val) => setChunkoverlapValue(val)}
                                                        mode={mode}
                                                    />
