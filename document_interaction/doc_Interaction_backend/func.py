...
def load_llm(customPrompt, temperature, max_tokens):
        ...
        logging.info ("Entering load_llm method call ")
        ...
        logging.debug(f' prompt template is: {promtemplate}')
        ...
        logging.basicConfig(format='%(asctime)s - %(message)s',datefmt='%m/%d/%Y %I:%M:%S %p', level=logging.INFO)
        logging.info ("Exiting load_llm method call ")
        return qa


def proc(query, customPrompt, temperature, max_tokens):
        logging.basicConfig(format='%(asctime)s - %(message)s',datefmt='%m/%d/%Y %I:%M:%S %p', level=logging.INFO)
        logging.info ("Entering proc method call ")
        ...
        logging.basicConfig(format='%(asctime)s - %(message)s',datefmt='%m/%d/%Y %I:%M:%S %p', level=logging.INFO)
        logging.info ("Exiting proc method call ")
        return[stranswer,strsource]

def excel(customPrompt, temperature, max_tokens):
    logging.basicConfig(format='%(asctime)s - %(message)s',datefmt='%m/%d/%Y %I:%M:%S %p', level=logging.INFO)
    logging.info ("Entering excel method call ")
    logging.basicConfig(format='%(asctime)s - %(message)s',datefmt='%m/%d/%Y %I:%M:%S %p', level=logging.DEBUG)
    logging.debug({customPrompt})
    #print(customPrompt)
...
# List all files in the directory
    ...
    agent = create_pandas_dataframe_agent(
                ...
                data,verbose=True)
    logging.basicConfig(format='%(asctime)s - %(message)s',datefmt='%m/%d/%Y %I:%M:%S %p', level=logging.DEBUG)
    logging.debug("Awaiting for answer from agent")
    #print("awaiting answer") 
    answer = agent.run(customPrompt)
    logging.basicConfig(format='%(asctime)s - %(message)s',datefmt='%m/%d/%Y %I:%M:%S %p', level=logging.DEBUG)
    logging.debug(f'Response from agent is: {answer}')
    logging.basicConfig(format='%(asctime)s - %(message)s',datefmt='%m/%d/%Y %I:%M:%S %p', level=logging.INFO)
    logging.info ("Exiting excel method call ")
    return answer